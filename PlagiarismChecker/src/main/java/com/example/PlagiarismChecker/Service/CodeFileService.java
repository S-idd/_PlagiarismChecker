...
public class CodeFileService {
    ...
    public CodeFileService(CodeFileRepository codeFileRepository, Validator validator, CustomCosineSimilarity cosineSimilarity) {
    ...
    public List<CodeFile> uploadBatchFiles(List<MultipartFile> files, String language) throws IOException {
        ...
        codeFiles.forEach(this::getTrigramVector);
        return codeFiles;
    }
